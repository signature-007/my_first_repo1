          ...
          return (
            <div className="masker" key={index}>
              <div className="w-fit flex items-center">
                {index === 1 && (
                  <div className="mask_image mr-[1vw] top-[0.1vw] mb-[2.7vw] rounded-md w-[8vw] h-[5.1vw] bg-green-500 "></div>
                )}
                <h1 className="mask_context uppercase tracking-tighter text-[7.5vw] leading-[5.4vw] font-['Founders_Grotesk'] font-bold">
                  {items}
                </h1>
              </div>
            </div>
